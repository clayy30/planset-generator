    ...
    return ProjectInput(
        ...
        array=ArrayLayout(
            ...
            structural=StructuralSystem(
                ...
                span_table_ref="IronRidge span tables · 131 mph Exp B · verify series",
            ),
            planes=[
                RoofPlane(
                    name="ROOF #1 (SOUTH)",
    ...
    return ProjectInput(
        ...
        meta=ProjectMeta(
            ...
            address=Address(
                ...
                owner_of_record="PHILLIPS JASON & JORDAN MARGARET",
                acres=0.02,
                legal_description="LT C SUB OF W PT OF LT 22  WASHINGTON WD",
                property_use="R3",
                latitude=32.077957,
                longitude=-81.085101,
                gis_source="SAGIS OpenData Parcels (verified)",
            ),
            utility="SOCO",
